...
def finalize_workout():
    ...
    print("Workout complete. Press a button to start another workout with the same frequency and placement.")
...
print("\nReady to start. Press the corresponding button on your device to start a workout.")
